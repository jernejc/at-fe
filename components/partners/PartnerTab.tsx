    ...
    const selectedPartnerAccounts = useMemo<MembershipWithProgress[]>(() => {
        ...
        if (selectedPartnerCompanies.length > 0) {
            return selectedPartnerCompanies.map((a, idx) => ({
                ...
                domain: a.company?.domain || a.company_domain,
                company_name: a.company?.name || a.company_name,
                industry: a.company?.industry || a.company_industry,
                employee_count: a.company?.employee_count ?? a.company_employee_count ?? null,
                hq_country: a.company?.hq_country || a.company_hq_country,
                segment: null,
