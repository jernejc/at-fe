    ...
    return (
        <div className="bg-white dark:bg-slate-900 border-b border-border/80 shrink-0 z-20 sticky top-0">
            <div className="max-w-[1600px] mx-auto px-6 h-16 flex items-center justify-between gap-4">
                {/* Brand (Left) */}
                <Link href="/" className="flex items-center gap-3 shrink-0 w-48 hover:opacity-80 transition-opacity">
                    ...
                    <div>
                        <h1 className="text-lg font-bold tracking-tight text-foreground leading-none font-display">LookAcross</h1>
