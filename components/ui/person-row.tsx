...
interface PersonRowProps {
  ...
  keyContact?: boolean;
  /** When true, hides the right-side metrics section entirely. */
  hideMetrics?: boolean;
  className?: string;
...
export function PersonRow({ person, onClick, isActive, selectable, selected, onSelect, keyContact, hideMetrics, className, ref }: PersonRowProps) {
  ...
  return (
    ...
    >
      ...
      {/* Metrics (hidden on mobile, or fully hidden when hideMetrics=true) */}
      {!hideMetrics && (
...
export function PersonRowSkeleton({ className, hideMetrics }: { className?: string; hideMetrics?: boolean }) {
  return (
